...
class Loader {
	 ...
	 *
	 * @var Acrossai_Core_Abilities_Loader
	 * @since 0.0.1
	 */
	...
	/**
	 * Main Acrossai_Core_Abilities_Loader Instance.
	 *
	 * Ensures only one instance of WooCommerce is loaded or can be loaded.
	 *
	 * @since 0.0.1
	 * @static
	 * @see Acrossai_Core_Abilities_Loader()
	 * @return Acrossai_Core_Abilities_Loader - Main instance.
	 */
