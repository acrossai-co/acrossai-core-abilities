...
final class Category_Registrar {
	...
	public function register(): void {
		wp_register_ability_category(
			'acrossai-core-abilities-plugins',
			array(
				'label'       => __( 'Acrossai Core Abilities — Plugin Management', 'acrossai-core-abilities' ),
				'description' => __( 'Abilities for managing WordPress plugins: install, activate, deactivate, list, and check for updates.', 'acrossai-core-abilities' ),
			)
		);
	}
}
