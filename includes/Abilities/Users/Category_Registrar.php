...
final class Category_Registrar {
	...
	public function register(): void {
		wp_register_ability_category(
			'acrossai-core-abilities-users',
			array(
				'label'       => __( 'Acrossai Core Abilities — User Management', 'acrossai-core-abilities' ),
				'description' => __( 'Abilities for reading, creating, updating, and deleting WordPress users, plus user meta and password resets.', 'acrossai-core-abilities' ),
			)
		);
	}
}
