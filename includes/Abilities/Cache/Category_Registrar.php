...
final class Category_Registrar {
	...
	public function register(): void {
		wp_register_ability_category(
			'acrossai-core-abilities-cache',
			array(
				'label'       => __( 'Acrossai Core Abilities — Cache Management', 'acrossai-core-abilities' ),
				'description' => __( 'Abilities for managing WordPress caches: flush object cache and related cache stores.', 'acrossai-core-abilities' ),
			)
		);
	}
}
